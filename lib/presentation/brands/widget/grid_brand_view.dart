...
class GridBrandView extends StatelessWidget {
  GridBrandView(this.brandItemModel);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Align(
          ...
          child: InkWell(
            onTap: (){
              if(brandItemModel.products_count!>0) {
                String brandId = brandItemModel.brand_id!;
                Map<String, dynamic> map = {};

                map['brandId'] = brandId;
                map['brandName'] = brandItemModel.brand_name;
                map['title']=brandItemModel.brand_name;
                ...
                children: [
                  ...
                  Expanded(flex:4,child: Container(
                    ...
                    Container(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl:brandItemModel.brand_img!,
                  ...
                  Expanded(flex:1,
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(brandItemModel.brand_name.toString(),
                  ...
                  Expanded(flex:1,
                      child: Container(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.only(start: 10.w),
                          child: Text('${brandItemModel.products_count.toString()} ${AppStrings.product.tr()}',
                            style: Theme.of(context).textTheme.displayMedium!.copyWith(
